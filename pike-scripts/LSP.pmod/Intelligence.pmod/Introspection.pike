...
//!
//! This class provides handlers for introspecting Pike code to extract
...
//! Introspection class - Extracts symbols and type information from Pike code
//!
//! Use: import LSP.Intelligence; object I = Introspection(ctx); I->handle_introspect(...);
class Introspection {
